; See detail on: https://nsis.sourceforge.io/Dump_log_to_file

!ifndef SETUP_FUNCTIONS_DUMP_LOG_NSH
!define SETUP_FUNCTIONS_DUMP_LOG_NSH
...
!endif ;SETUP_FUNCTIONS_DUMP_LOG_NSH