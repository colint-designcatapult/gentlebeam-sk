...
namespace Empyrean.Common.Application.Models
{
    ...
    public class DirtyFlaggedBindableBase : INotifyPropertyChanged, IDirtyFlaggedBindableBase
    {
        public DirtyFlaggedBindableBase()
        {
        ...
        {
            if (this.GetType().Name == "CoilConfigurations")
                ;
        ...
        public bool IsValid
        {
            ...
            set
            {
                ...
                {
                    OnIsValidChanged(this, _isValid);
                }
            }
        }
        ...
        public void Validate(object? propertyValue, [CallerMemberName] string propertyName = null!)
        {
            var results = new List<ValidationResult>();

            bool res = Validator.TryValidateProperty(propertyValue, new ValidationContext(this)
            {
            ...
            //Debug.WriteLine($"{propertyName} => {res}");
        ...
        protected virtual void OnErrorsChanged(string propertyName)
        {
            ...
            var results = new List<ValidationResult>();
            IsValid = Validator.TryValidateObject(this, new ValidationContext(this), results, true);
        }
