...
{
    public class GrpcTreatmentDeviceCommands
        : ChildEntryCommandWrapper<ITreatmentDevice, TreatmentDevice, GrpcTreatmentDeviceMethodsInvoker>
        , IEmrTreatmentDeviceCommands
    {
        public GrpcTreatmentDeviceCommands(GrpcTreatmentDeviceMethodsInvoker invoker)
