...
{
    public class GrpcPrescriptionCommands
        : ChildEntryCommandWrapper<IPrescription, Prescription, GrpcPrescriptionMethodsInvoker>
        , IEmrPrescriptionCommands
    {
        public GrpcPrescriptionCommands(GrpcPrescriptionMethodsInvoker invoker)
