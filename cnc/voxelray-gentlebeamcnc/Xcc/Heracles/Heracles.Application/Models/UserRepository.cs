...
namespace Heracles.Application.Models
{
    public class UserRepository(
        ...
        IUserRoleMappingCommandsExt userRoleMappingCommands,
        ...
        : IUserRepository
    {
        public async Task<ICollection<IUser>> FetchUsersAsync()
        {
            ...
            {
                user.Role = await FetchUserRoleAsync(user.EmailAddress);
            }
        ...
        {
            var roleMappings = await userRoleMappingCommands.ReadListAsync(userEmail);
